...
T070_BASELINE_REF = "0025d19"  # T133 round 2: eighth line reworded, ninth added (CLAUDE.md +1 line)
...
T133_BASELINE_REF = "0025d19"  # T133 round 2: ninth rule line adds chars to the template
